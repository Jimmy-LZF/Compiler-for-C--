...
yyreduce:
  ...
  case 2:
#line 63 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "Program", 1, (yyvsp[0].node)); root = (yyval.node); }
#line 1558 "syntax.tab.c"
    break;

  case 3:
#line 65 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "ExtDefList", 2, (yyvsp[-1].node), (yyvsp[0].node)); }
...
#line 1570 "syntax.tab.c"
  ...
  case 5:
#line 68 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "ExtDef", 3, (yyvsp[-2].node), (yyvsp[-1].node), (yyvsp[0].node)); }
#line 1576 "syntax.tab.c"
    break;

  case 6:
#line 69 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "ExtDef", 2, (yyvsp[-1].node), (yyvsp[0].node)); }
...
#line 1594 "syntax.tab.c"
  ...
  case 9:
#line 73 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "ExtDecList", 1, (yyvsp[0].node)); }
#line 1600 "syntax.tab.c"
    break;

  case 10:
#line 74 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "ExtDecList", 3, (yyvsp[-2].node), (yyvsp[-1].node), (yyvsp[0].node)); }
#line 1606 "syntax.tab.c"
    break;

  case 11:
#line 78 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "Specifier", 1, (yyvsp[0].node)); }
...
#line 1618 "syntax.tab.c"
  ...
  case 13:
#line 81 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "StructSpecifier", 5, (yyvsp[-4].node), (yyvsp[-3].node), (yyvsp[-2].node), (yyvsp[-1].node), (yyvsp[0].node)); }
#line 1624 "syntax.tab.c"
    break;

  case 14:
#line 82 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "StructSpecifier", 2, (yyvsp[-1].node), (yyvsp[0].node)); }
#line 1630 "syntax.tab.c"
    break;

  case 15:
#line 84 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "OptTag", 1, (yyvsp[0].node)); }
...
#line 1642 "syntax.tab.c"
  ...
  case 17:
#line 87 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "Tag", 1, (yyvsp[0].node)); }
#line 1648 "syntax.tab.c"
    break;

  case 18:
#line 91 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "VarDec", 1, (yyvsp[0].node)); }
#line 1654 "syntax.tab.c"
    break;

  case 19:
#line 92 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "VarDec", 4, (yyvsp[-3].node), (yyvsp[-2].node), (yyvsp[-1].node), (yyvsp[0].node)); }
...
#line 1666 "syntax.tab.c"
  ...
  case 21:
#line 95 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "FunDec", 4, (yyvsp[-3].node), (yyvsp[-2].node), (yyvsp[-1].node), (yyvsp[0].node)); }
#line 1672 "syntax.tab.c"
    break;

  case 22:
#line 96 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "FunDec", 3, (yyvsp[-2].node), (yyvsp[-1].node), (yyvsp[0].node)); }
...
#line 1684 "syntax.tab.c"
  ...
  case 24:
#line 99 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "VarList", 3, (yyvsp[-2].node), (yyvsp[-1].node), (yyvsp[0].node)); }
#line 1690 "syntax.tab.c"
    break;

  case 25:
#line 100 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "VarList", 1, (yyvsp[0].node)); }
#line 1696 "syntax.tab.c"
    break;

  case 26:
#line 102 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "ParamDec", 2, (yyvsp[-1].node), (yyvsp[0].node)); }
#line 1702 "syntax.tab.c"
    break;

  case 27:
#line 105 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "CompSt", 4, (yyvsp[-3].node), (yyvsp[-2].node), (yyvsp[-1].node), (yyvsp[0].node)); }
...
#line 1714 "syntax.tab.c"
  ...
  case 29:
#line 108 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "StmtList", 2, (yyvsp[-1].node), (yyvsp[0].node)); }
...
#line 1726 "syntax.tab.c"
  ...
  case 31:
#line 111 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "Stmt", 2, (yyvsp[-1].node), (yyvsp[0].node)); }
#line 1732 "syntax.tab.c"
    break;

  case 32:
#line 112 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "Stmt", 1, (yyvsp[0].node)); }
#line 1738 "syntax.tab.c"
    break;

  case 33:
#line 113 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "Stmt", 3, (yyvsp[-2].node), (yyvsp[-1].node), (yyvsp[0].node)); }
#line 1744 "syntax.tab.c"
    break;

  case 34:
#line 114 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "Stmt", 5, (yyvsp[-4].node), (yyvsp[-3].node), (yyvsp[-2].node), (yyvsp[-1].node), (yyvsp[0].node)); }
#line 1750 "syntax.tab.c"
    break;

  case 35:
#line 115 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "Stmt", 7, (yyvsp[-6].node), (yyvsp[-5].node), (yyvsp[-4].node), (yyvsp[-3].node), (yyvsp[-2].node), (yyvsp[-1].node), (yyvsp[0].node)); }
...
#line 1768 "syntax.tab.c"
  ...
  case 38:
#line 120 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "DefList", 2, (yyvsp[-1].node), (yyvsp[0].node)); }
...
#line 1780 "syntax.tab.c"
  ...
  case 40:
#line 123 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "Def", 3, (yyvsp[-2].node), (yyvsp[-1].node), (yyvsp[0].node)); }
#line 1786 "syntax.tab.c"
    break;

  case 41:
#line 125 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "DecList", 1, (yyvsp[0].node)); }
#line 1792 "syntax.tab.c"
    break;

  case 42:
#line 126 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "DecList", 3, (yyvsp[-2].node), (yyvsp[-1].node), (yyvsp[0].node)); }
#line 1798 "syntax.tab.c"
    break;

  case 43:
#line 128 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "Dec", 1, (yyvsp[0].node)); }
#line 1804 "syntax.tab.c"
    break;

  case 44:
#line 129 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "Dec", 3, (yyvsp[-2].node), (yyvsp[-1].node), (yyvsp[0].node)); }
#line 1810 "syntax.tab.c"
    break;

  case 45:
#line 132 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "Exp", 3, (yyvsp[-2].node), (yyvsp[-1].node), (yyvsp[0].node)); }
...
#line 1864 "syntax.tab.c"
  ...
  case 54:
#line 141 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "Exp", 2, (yyvsp[-1].node), (yyvsp[0].node)); }
...
#line 1876 "syntax.tab.c"
  ...
  case 56:
#line 143 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "Exp", 4, (yyvsp[-3].node), (yyvsp[-2].node), (yyvsp[-1].node), (yyvsp[0].node)); }
...
#line 1900 "syntax.tab.c"
  ...
  case 60:
#line 147 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "Exp", 1, (yyvsp[0].node)); }
...
#line 1918 "syntax.tab.c"
  ...
  case 63:
#line 151 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "Args", 3, (yyvsp[-2].node), (yyvsp[-1].node), (yyvsp[0].node)); }
#line 1924 "syntax.tab.c"
    break;

  case 64:
#line 152 "syntax.y"
                                                            { (yyval.node) = notTokenNode((yyloc).first_line, NOT_A_TOKEN, "Args", 1, (yyvsp[0].node)); }
